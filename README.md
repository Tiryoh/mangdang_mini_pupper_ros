...
Ubuntu 22.04 and ROS 2 Humble is required.

You should first install dependencies of servos, battery moniter and display screen.  
See [mini_pupper_ros_bsp](https://github.com/mangdangroboticsclub/mini_pupper_ros_bsp).
...
# Terminal 2
. ~/ros2_ws/install/setup.bash
ros2 launch mini_pupper_navigation bringup.launch.py slam:=true use_sim_time:=true
```
...
All the nodes needed to access the hardware of Mini Pupper are running as services.  
Therefore, all you need to do is start the ROS node on your PC.

### 2.2.1 Test walk

Note: This step is only for Mini Pupper

Open a terminal on your PC and run the following command:
